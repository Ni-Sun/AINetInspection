...
VALUES (
        ...
        1,
        '人物识别',
        '画面中具有四肢和躯干的生命体，涵盖不同姿态与衣着的人类个体，无论站立、行走、奔跑或坐卧等动态均能精准定位，可适应复杂场景下的人体特征。',
        '/planpath/1.png',
        NULL,
        NULL,
        NULL,
        '公共安全、公安行业、智慧社区、车站、活动管理'
    );
...
VALUES (
        ...
        2,
        '自行车识别',
        '有两轮、车架、车把和座椅的非机动骑行工具，包含山地车、公路车、折叠车等不同类型，支持动态行驶状态检测，能准确分辨车架结构、车轮形态等细节特征，适用于户外道路等场景的。',
        '/planpath/2.png',
        NULL,
        NULL,
        NULL,
        '城市道路、交通治理、智慧停车、购物中心、社区'
    );
...
VALUES (
        ...
        3,
        '汽车识别',
        '四轮、封闭车身的机动道路车辆，可区分轿车、SUV、MPV 等不同车型，适应白天、夜晚等各种光照条件，能精准车身轮廓、车窗形态及车轮数量等特征，适用于城市交通、停车场等多场景的目标检测。',
        '/planpath/3.png',
        NULL,
        NULL,
        NULL,
        '城市道路、交通治理、智慧停车、机场、智慧工地'
    );
...
VALUES (
        ...
        4,
        '摩托车识别',
        '两轮、发动机驱动的机动交通工具，包括巡航、越野、踏板等不同款式，通过捕捉车身引擎、车轮、座椅等细节特征实现精准，可在道路、街道等场景中对行驶或停放的摩托车进行有效检测。',
        '/planpath/4.png',
        NULL,
        NULL,
        NULL,
        '消防行业、公安行业、城市道路、交通治理、智慧停车'
    );
...
VALUES (
        ...
        5,
        '飞机识别',
        '具有机翼、机身的航空运输工具，可分辨民航客机、直升机、战斗机等不同类别，支持空中多角度，能捕捉机翼形状、机身轮廓及飞行姿态等特征，适用于机场、空域等场景的目标检测与分类。',
        '/planpath/5.png',
        NULL,
        NULL,
        NULL,
        '机场、交通枢纽、公安行业、公共安全、城市治理'
    );
...
VALUES (
        ...
        6,
        '公共汽车识别',
        '包含单层、双层、铰接式等不同结构，能适应城市道路、公交站台等复杂背景环境，通过车身长度、车窗排列、车门位置等特征实现精准检测，适用于公共交通场景的目标任务',
        '/planpath/6.png',
        NULL,
        NULL,
        NULL,
        '城市道路、交通枢纽、交通治理、智慧停车、车站'
    );
...
VALUES (
        ...
        7,
        '火车识别',
        '由多节车厢连接组成的轨道运输工具，包含客运列车、货运列车等不同类型，可检测列车行驶方向、车厢数量及轮廓特征，适用于铁路、火车站等场景的目标检测与追踪。',
        '/planpath/7.png',
        NULL,
        NULL,
        NULL,
        '火车站、交通枢纽、基础设施管理、交通治理、城市治理'
    );
...
VALUES (
        ...
        8,
        '卡车识别',
        '大型载货的商用车辆，可区分厢式货车、平板货车、自卸车等不同车型，通过检测车身结构、车轮数量及货物装载特征实现精准分类，适用于物流园区、公路运输等场景的目标。',
        '/planpath/8.png',
        NULL,
        NULL,
        NULL,
        '智慧园区、城市道路、交通治理、基础设施管理、园区'
    );
...
VALUES (
        ...
        9,
        '船只识别',
        '在水域航行的交通工具，包括货船、客船、游艇等不同类型，支持水面、港口等场景的多角度，能捕捉船体形状、甲板结构及航行状态等特征，实现水域目标的有效检测。',
        '/planpath/9.png',
        NULL,
        NULL,
        NULL,
        '交通枢纽、基础设施管理、环境保护、渔业管理、城市治理'
    );
...
VALUES (
        ...
        10,
        '交通信号灯识别',
        '道路上用于指挥交通的信号装置，可区分红灯、绿灯、黄灯等不同状态，通过检测灯组颜色、亮灭模式及信号灯形状等特征，实现交通状态的智能，适用于城市路口等场景的交通监控。',
        '/planpath/10.png',
        NULL,
        NULL,
        NULL,
        '城市道路、交通治理、公共安全、智慧停车、基础设施管理'
    );
...
VALUES (
        ...
        11,
        '消防栓识别',
        '安装在公共区域的消防供水设备，包含地上式、地下式等不同类型，通过检测栓体形状、阀门结构及周边环境特征，实现消防设施的精准定位，适用于城市街道、建筑物周边等场景的安全监测。',
        '/planpath/11.png',
        NULL,
        NULL,
        NULL,
        '消防行业、公共安全、城市治理、基础设施管理'
    );
...
VALUES (
        ...
        12,
        '停车标志识别',
        '道路上指示停车的交通标志，通常为八角形红底白字，通过检测标志形状、颜色及文字特征实现精准，适用于城市道路、停车场等场景的交通设施检测。',
        '/planpath/12.png',
        NULL,
        NULL,
        NULL,
        '交通治理、城市道路、智慧停车、基础设施管理、公共安全'
    );
...
VALUES (
        ...
        13,
        '停车计时器识别',
        '路边用于计时收费的设备，包含机械式、电子屏式等不同类型，通过检测设备外形、显示屏状态及安装位置等特征，实现城市公共停车区域的智能监控。',
        '/planpath/13.png',
        NULL,
        NULL,
        NULL,
        '智慧停车、城市道路、交通治理、基础设施管理、公共安全'
    );
...
VALUES (
        ...
        14,
        '长椅识别',
        '公园、街道等公共场所供人休息的座椅，包含木质、金属、石质等不同材质，通过检测座椅形状、结构及周边环境特征，实现城市公共设施的智能。',
        '/planpath/14.png',
        NULL,
        NULL,
        NULL,
        '城市治理、基础设施管理、社区、园区、智慧园区'
    );
...
VALUES (
        ...
        15,
        '鸟类识别',
        '具有羽毛、翅膀和喙的飞禽，涵盖麻雀、鸽子、喜鹊等不同种类，通过检测体型、羽毛颜色及飞行姿态等特征，实现自然环境中的鸟类与监测。',
        '/planpath/15.png',
        NULL,
        NULL,
        NULL,
        '环境保护、城市治理、园区、活动管理、平安校园'
    );
...
VALUES (
        ...
        16,
        '人员跌倒检测',
        '实时检测人员跌倒行为，系统能够在检测到人员摔倒时立即发出警示，以便快速采取救援措施，确保受害者安全，特别适用于老年人、病患或高危工作环境。',
        '/planpath/18.png',
        NULL,
        NULL,
        NULL,
        '智慧医院、智慧社区、公共安全、工地、平安校园'
    );
...
VALUES (
        ...
        17,
        '雨伞识别',
        '用于遮雨的工具，由伞面和伞骨组成，撑开后呈圆形，可通过检测开合状态、伞面颜色及骨架结构等特征，在雨天街道、建筑物入口等场景进行。',
        '/planpath/19.png',
        NULL,
        NULL,
        NULL,
        '城市道路、购物中心、车站、城市治理、公共安全'
    );
...
VALUES (
        ...
        18,
        '手提包识别',
        '用于手持的包类，设计多样，有单肩带或手提带，可装随身物品，能通过检测包身形状、提带样式及装饰细节等特征，在商场、街道等场景实现。',
        '/planpath/20.png',
        NULL,
        NULL,
        NULL,
        '购物中心、城市道路、公共安全、活动管理、智慧零售'
    );
...
VALUES (
        ...
        19,
        '手提箱识别',
        '用于旅行的有轮拉杆箱，箱体坚硬，有轮子和拉杆，方便拖拉，可通过检测箱体形状、轮子数量及拉杆状态等特征，在机场、火车站等场景实现。',
        '/planpath/21.png',
        NULL,
        NULL,
        NULL,
        '交通枢纽、智慧停车、公共安全、活动管理、基础设施管理'
    );
...
VALUES (
        ...
        20,
        '风筝识别',
        '自动识别通过长线控制，可通过检测形状、颜色及飞行姿态等特征，在广场、郊外等空旷场景进行。',
        '/planpath/22.png',
        NULL,
        NULL,
        NULL,
        '城市治理、活动管理、园区、社区、环境保护'
    );
...
VALUES (
        ...
        21,
        '瓶子识别',
        '用于盛装液体的容器，有不同材质和形状，可通过检测瓶身轮廓、瓶盖特征及标签纹理等实现，适用于超市、厨房等场景。',
        '/planpath/23.png',
        NULL,
        NULL,
        NULL,
        '智慧零售、后厨、基础设施管理、公共安全、智慧园区'
    );
...
VALUES (
        ...
        22,
        '烟火检测',
        '公共安全在加油站、后厨以及公共场所等对卫生和安全要求较高的区域，实施烟火检测系统进行实时监控，确保及时检测并防范潜在的火灾风险。通过安装高灵敏度的烟火传感器和摄像头，结合图像识别技术，能够快速识别并报警，从而有效预防和减少火灾事故的发生。',
        '/planpath/24.png',
        NULL,
        NULL,
        NULL,
        '智慧医院 后厨 化工生产 智慧园区 园区 公安消防 消防行业'
    );
...
VALUES (
        ...
        23,
        '杯子识别',
        '用于盛装液体的容器，有多种材质和样式，可通过检测杯口形状、杯身纹理及有无杯把等特征，在厨房、办公室等场景实现。',
        '/planpath/25.png',
        NULL,
        NULL,
        NULL,
        '后厨、智慧零售、办公室、基础设施管理、家庭'
    );
...
VALUES (
        ...
        24,
        '刀具识别',
        '切割工具，由刀刃和刀柄组成，可通过检测形状、长度及使用状态等特征，在厨房、餐厅等场景进行，需注意安全场景下的特殊需求。',
        '/planpath/26.png',
        NULL,
        NULL,
        NULL,
        '后厨、公共安全、餐厅、智慧零售、活动管理'
    );
...
VALUES (
        ...
        25,
        '椅子识别',
        '供人坐的家具，有椅面、椅背和椅腿，可通过检测结构、材质及使用状态等特征，在会议室、餐厅等场景实现。',
        '/planpath/27.png',
        NULL,
        NULL,
        NULL,
...
VALUES (
        ...
        26,
        '沙发识别',
        '多人坐的沙发家具，有多个座位和靠背，可通过检测形状、尺寸及与周围环境的关系等特征，在客厅、休息室等场景进行。',
        '/planpath/28.png',
        NULL,
        NULL,
        NULL,
...
VALUES (
        ...
        27,
        '盆栽植物识别',
        '种植在花盆中的植物，有茎叶和花盆，可通过检测植物形态、叶子纹理及花盆形状等特征，在室内外装饰场景进行。',
        '/planpath/29.png',
        NULL,
        NULL,
        NULL,
...
VALUES (
        ...
        28,
        '床铺识别',
        '供人睡觉的家具，有床垫和床架，可通过检测形状、尺寸及床上用品状态等特征，在卧室等场景实现。',
        '/planpath/30.png',
        NULL,
        NULL,
        NULL,
        '智慧医院、智慧社区、基础设施管理、平安校园'
    );
...
VALUES (
        ...
        29,
        '餐桌识别',
        '用餐家具，有桌面和桌腿，可通过检测形状、尺寸及与餐椅的组合关系等特征，在餐厅、厨房等场景进行。',
        '/planpath/31.png',
        NULL,
        NULL,
        NULL,
...
VALUES (
        ...
        30,
        '电视识别',
        '播放图像和声音的设备，有屏幕和外壳，可通过检测屏幕形状、边框特征及播放内容状态等特征，在客厅、卧室等场景进行。',
        '/planpath/32.png',
        NULL,
        NULL,
        NULL,
...
VALUES (
        ...
        31,
        '笔记本电脑识别',
        '可携带的计算机设备，有屏幕和键盘，可通过检测开合状态、屏幕尺寸及使用状态等特征，在办公室、图书馆等场景进行。',
        '/planpath/33.png',
        NULL,
        NULL,
        NULL,
...
VALUES (
        ...
        32,
        '手机识别',
        '便携式通信设备，有屏幕和机身，可通过检测形状、尺寸及使用状态（如是否手持）等特征，在各种场景中进行。',
        '/planpath/34.png',
        NULL,
        NULL,
        NULL,
...
VALUES (
        ...
        33,
        '背包识别',
        '用于背负的包类，有双肩带设计，可装书本、衣物等物品，能通过检测包身形状、肩带结构及材质纹理等特征，实现校园、户外等场景下的背包。',
        '/planpath/35.png',
        NULL,
        NULL,
        NULL,
